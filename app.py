...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://admin:mNcE2edLtlsXSalFFM99qcUBn5W0vUvP@dpg-cf35u1mn6mpkr681f3l0-a.oregon-postgres.render.com/chatbot_fpge"
db = SQLAlchemy(app)
CORS(app)
## Database
